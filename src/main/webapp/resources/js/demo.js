...
$(function () {
  ...
  var $demoSettingsUpper = $('<div/>')
  
/*  var $skinsUpper = $('<ul />', { 'class': 'list-unstyled list-unstyled_C ' })
   var $skinGreenUpper =
        $('<li />', { style: 'float:left; width: 20.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-green" style="display: block;" class="clearfix full-opacity-hover">'
            + '<div><span class="theme_color_screen" style="display:block; width: 100%; float: left; height: 40px;"><i class="fas fa-paint-brush"></i></span></div>'
            + '</a>')
            
  $skinsUpper.append($skinGreenUpper)
  
  
  $demoSettingsUpper.append('<h4 class="control-sidebar-heading">Theme Dark</h4>')
  $demoSettingsUpper.append($skinsUpper);
  
  $tabPane.append($demoSettingsUpper)
  $('#control-sidebar-home-tab').after($tabPane)*/

  
  
  var $skinsList = $('<ul />', { 'class': 'list-unstyled list-unstyled_C clearfix' })
  ...
  var $skinBlack =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-black" style="display: block;" class="clearfix full-opacity-hover">'
            + '<div class="clearfix"><span style="display:block; width: 100%; float: left; height: 20px; background: #242a33;"></span><span style="display:block; width: 100%; float: left; height: 40px; background: #0033c4;"></span></div>'
            + '</a>')
  $skinsList.append($skinBlack)
    var $skinGreen =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-green" style="display: block;" class="clearfix full-opacity-hover">'
            + '<div class="clearfix"><span style="display:block; width: 100%; float: left; height: 20px; background: #242a33;"></span><span style="display:block; width: 100%; float: left; height: 40px; background: #000;"></span></div>'
            + '</a>')
  ...
  var $skinBlackLight =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-black-light" style="display: block;" class="clearfix full-opacity-hover">'
            + '<div class="clearfix"><span style="display:block; width: 100%; float: left; height: 20px; background: #242a33;"></span><span style="display:block; width: 100%; float: left; height: 40px; background: #2A3E52;"></span></div>'
            + '</a>')
